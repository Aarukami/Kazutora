...
PM_START_TEXT = """
ʜᴇʟʟᴏ [🤗](https://te.legra.ph/file/c92969a6d049b58954cdc.jpg), ɪᴍ komi ᴀ ʜɪɢʜʏ ᴀᴅᴠᴀɴᴄᴇᴅ ʙᴏᴛ ᴡɪᴛʜ ʟᴏᴛꜱ ᴏꜰ ᴀᴍᴀᴢɪɴɢ ᴛᴏᴏʟꜱ.
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ Add komi to your group ➕️", url="t.me/komiXRoBot?startgroup=true"),
    ],
    [
...
HELP_STRINGS = """
`ʜɪ.. ɪ'ᴍ` [komi san🙋‍♀️](https://te.legra.ph/file/c92969a6d049b58954cdc.jpg) 
`ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴꜱ ʙᴇʟᴏᴡ ᴛᴏ ɢᴇᴛ ᴅᴏᴄᴜᴍᴇɴᴛᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ꜱᴘᴇᴄɪꜰɪᴄ ᴍᴏᴅᴜʟᴇꜱ..`"""

yone_IMG = "https://te.legra.ph/file/1fcf1b2e9b6deecdce725.jpg"
...
def yone_about_callback(update, context):
    ...
    if query.data == "komi_":
        query.message.edit_text(
            text=""" ℹ️ I'm *komi san*, a powerful group management bot built to help you manage your group easily.
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *yone*
                 \nHere is the [Source Code](https://github.com/Aarukami/kazutora) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
